                ...
                <div className="row">
                    <div className="col-12 col-sm-6 col-lg-3">
                        <div className={styles.cardDiarias}>
                            ...
                            <div className="d-flex justify-content-center align-items-center">
                                <Image src="/img-padrao.svg" alt="imagem produto" width={150} height={150} />
                            </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                        <div className={styles.cardDiarias}>
                            ...
                            <p className={styles.produto}>Bermuda Nike Monster Mesh 5.0 Masculina</p>
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                        <div className={styles.cardDiarias}>
                            ...
                            <p className={styles.produto}>Bicicleta South Stark 2021 Alumínio freio a...</p>
