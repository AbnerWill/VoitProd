...
export default function CondicoesEspeciais() {
    ...
    return (
        <div style={{backgroundColor: '#EAEDF5', padding: '20px 0', margin: '20px 0 0 0'}}>
            <Container>
                <div className="row">
                    <div className="col-12 col-sm-6 col-md-3 text-center">
                        <p style={condicaoEspecial}>Condição especial 01</p>
                        <span style={descricaoCondicao}>Descrição sobre a<br />condição</span>
                    </div>
                    <div className="col-12 col-sm-6 col-md-3 text-center">
                        <p style={condicaoEspecial}>Condição especial 02</p>
                        <p style={descricaoCondicao}>Descrição sobre a<br />condição</p>
                    </div>
                    <div className="col-12 col-sm-6 col-md-3 text-center">
